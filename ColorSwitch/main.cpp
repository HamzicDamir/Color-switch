...
void checkCircle()
{
     if(circle.getCircles().at(11).getY()>0 ||circle.getCircles().at(12).getY()>0)
        {
            if(((ball.getPosition()-circle.getCircles().at(11).getY())<6  &&
                (ball.getPosition()-circle.getCircles().at(11).getY())>-6) ||
               ((ball.getPosition()-circle.getCircles().at(12).getY())<6  &&
               (ball.getPosition()-circle.getCircles().at(12).getY())>-6))
                {
        ...
        {
            if(((ball.getPosition()-circle.getCircles().at(0).getY())<6  &&
                (ball.getPosition()-circle.getCircles().at(0).getY())>-6) ||
               ((ball.getPosition()-circle.getCircles().at(1).getY())<6  &&
               (ball.getPosition()-circle.getCircles().at(1).getY())>-6))
                {
...
void checkCircle1()
{
    if(circle1.getCircles().at(11).getY()>0 ||circle1.getCircles().at(12).getY()>0)
        {
            if(((ball.getPosition()-circle1.getCircles().at(11).getY())<8  &&
                (ball.getPosition()-circle1.getCircles().at(11).getY())>-8) ||
               ((ball.getPosition()-circle1.getCircles().at(12).getY())<8  &&
               (ball.getPosition()-circle1.getCircles().at(12).getY())>-8))
                {
        ...
        {
            if(((ball.getPosition()-circle1.getCircles().at(0).getY())<8  &&
                (ball.getPosition()-circle1.getCircles().at(0).getY())>-8) ||
               ((ball.getPosition()-circle1.getCircles().at(1).getY())<8  &&
               (ball.getPosition()-circle1.getCircles().at(1).getY())>-8))
                {
...
void  checkIfDoneTriangle()
{
        ...
        {
            if(((ball.getPosition()-triangle.getTriangles().at(10).getY())<8  &&
                (ball.getPosition()-triangle.getTriangles().at(10).getY())>-8) ||
               ((ball.getPosition()-triangle.getTriangles().at(11).getY())<8  &&
               (ball.getPosition()-triangle.getTriangles().at(11).getY())>-8) ||
               ((ball.getPosition()-triangle.getTriangles().at(12).getY())<8  &&
               (ball.getPosition()-triangle.getTriangles().at(12).getY())>-8))
                {
        ...
        {
            if(((ball.getPosition()-triangle.getTriangles().at(0).getY())<8  &&
                (ball.getPosition()-triangle.getTriangles().at(0).getY())>-8) ||
               ((ball.getPosition()-triangle.getTriangles().at(23).getY())<8  &&
               (ball.getPosition()-triangle.getTriangles().at(23).getY())>-8) ||
               ((ball.getPosition()-triangle.getTriangles().at(1).getY())<8  &&
               (ball.getPosition()-triangle.getTriangles().at(1).getY())>-8))
                {
...
void checkIfDoneSquare()
{
        ...
        {
            if(((ball.getPosition()-square.getSquares().at(15).getY())<8  &&
                (ball.getPosition()-square.getSquares().at(15).getY())>-8) ||
               ((ball.getPosition()-square.getSquares().at(16).getY())<8  &&
               (ball.getPosition()-square.getSquares().at(16).getY())>-8) ||
               ((ball.getPosition()-square.getSquares().at(14).getY())<8  &&
               (ball.getPosition()-square.getSquares().at(14).getY())>-8))
                {
        ...
        {
            if(((ball.getPosition()-square.getSquares().at(2).getY())<8  &&
                (ball.getPosition()-square.getSquares().at(2).getY())>-8) ||
               ((ball.getPosition()-square.getSquares().at(3).getY())<8  &&
               (ball.getPosition()-square.getSquares().at(3).getY())>-8) ||
               ((ball.getPosition()-square.getSquares().at(4).getY())<8  &&
               (ball.getPosition()-square.getSquares().at(4).getY())>-8))
                {
